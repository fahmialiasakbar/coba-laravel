...
@section('container')
        ...
        <div class="col-md-6">
            <form action="/posts">
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-success" type="submit" id="button-addon2">Seach</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body text-center">
            <h3 class="card-title">
                <a href="/posts/{{ $posts[0]->id }}" class="text-decoration-none">
                    {{ $posts[0]->title }}
                </a>
            </h3>
            <p>
            ...
            <a href="/posts/{{ $posts[0]->id }}" class="text-decoration-none btn btn-primary">
                Read More..
            </a>
        </div>
    </div>
